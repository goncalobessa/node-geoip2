...
Decoder = module.exports = function Decoder(fileStream, pointerBase) {
...
Decoder.prototype.decode = function decode(offset) {
    ...
    if (type === 'extended') {
        ...
        if (tmp < 8) {
            throw new Error('GeoIP2: Invalid Extended Type at offset:' + offset);
        }
...
Decoder.prototype.decodeByType = function decodeByType(type, offset, size) {
    ...
    switch (type) {
        ...
        default:            throw new Error("GeoIP2: Unknown or unexpected type: " + type + ' at offset:' + offset);
    }
};
